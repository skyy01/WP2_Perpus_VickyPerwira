...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>user/css/bootstrap.css" <link href="<?= base_url('assets/'); ?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
